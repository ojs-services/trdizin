...
<form class="pkp_form" id="trdizinSettingsForm" method="post" action="{url router=PKP\core\PKPApplication::ROUTE_COMPONENT op="manage" plugin="TRDizinExportPlugin" category="importexport" verb="save"}">
	{csrf}
